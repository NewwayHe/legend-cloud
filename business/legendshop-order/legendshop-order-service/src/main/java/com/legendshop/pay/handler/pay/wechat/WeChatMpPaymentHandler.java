 ...
 */
@Component("MP_WX_PAY")
public class WeChatMpPaymentHandler extends AbstractWeChatPaymentHandler {
	...
	protected String doBeforeResponse(Map<String, String> resultMap) {
		...
		Map<String, String> packageParams = WxPayKit.prepayIdCreateSign(prepayId, appId, partnerKey, SignType.MD5);
