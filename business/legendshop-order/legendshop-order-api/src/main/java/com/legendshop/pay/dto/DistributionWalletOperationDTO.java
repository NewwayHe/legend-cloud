...
import com.legendshop.pay.enums.DistributionWithdrawBusinessTypeEnum;
import com.legendshop.pay.enums.DistributionWithdrawOperationTypeEnum;
import com.legendshop.pay.enums.WalletTransactionTypeEnum;
 ...
 */
@Data
public class DistributionWalletOperationDTO implements Serializable {
	...
	private DistributionWithdrawBusinessTypeEnum businessType;

	/**
	 * 操作类型（收入，支出）
	 */
	@Schema(description = "操作类型（收入，支出）")
	private DistributionWithdrawOperationTypeEnum operationType;
