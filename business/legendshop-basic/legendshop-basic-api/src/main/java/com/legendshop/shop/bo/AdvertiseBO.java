 ...
 */
@Data
public class AdvertiseBO implements Serializable {

	private static final long serialVersionUID = -36205213733012880L;
	 ...
	 * 投放广告用户类型
	 */
	@Schema(description = "投放广告用户类型")
	private String advertiseUesrType;

	/**
	 * 渠道：pc端,移动端
	 */
	@Schema(description = "渠道：pc端,移动端")
