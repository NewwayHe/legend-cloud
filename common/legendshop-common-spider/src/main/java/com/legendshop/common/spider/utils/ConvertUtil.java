 ...
 *
 */
package com.legendshop.common.spider.utils;

import com.legendshop.common.core.util.ClassUtil;
import com.legendshop.common.spider.core.SpiderConversionService;
...
public class ConvertUtil {
	...
	public static <T> T convert(@Nullable Object source, Class<T> targetType) {
		...
		GenericConversionService conversionService = SpiderConversionService.getInstance();
