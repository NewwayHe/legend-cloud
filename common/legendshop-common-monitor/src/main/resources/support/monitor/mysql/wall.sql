...
CREATE
INDEX druid_wall_index ON druid_wall (collectTime, domain, app);
...
CREATE
INDEX druid_wall_sql_index ON druid_wall_sql (collectTime, domain, app);
...
CREATE
INDEX druid_wall_table_index ON druid_wall_table (collectTime, domain, app);
...
CREATE
INDEX druid_wall_function_index ON druid_wall_function (collectTime, domain, app);